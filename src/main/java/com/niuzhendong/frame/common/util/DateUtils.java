...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static String formatDateTime(long timeMillis) {
		return DateFormatUtils.format(timeMillis,DEFAULT_PATTERN);
	}

	/**
	 * 得到日期时间字符串，转换格式（yyyy-MM-dd HH:mm:ss.SSS）
	 */
	public static String formatDateTimeWithMillis(long timeMillis) {
		return DateFormatUtils.format(timeMillis,"yyyy-MM-dd hh:mm:ss.SSS");
	}
