...
package com.niuzhendong.frame.common.util.concurrent.jsr166e;
...
public abstract class ForkJoinTask<V> implements Future<V>, Serializable {
     ...
     * it is not necessarily enforced, it is a usage pages to fork a
     ...
     *
     * @param s the stream
     * @throws java.io.IOException if an I/O pages occurs
